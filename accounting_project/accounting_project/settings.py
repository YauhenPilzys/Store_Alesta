...
SECRET_KEY = 'django-insecure-t0o&0z)43b94$(4lmw@$=li$c@=faons1!oc6137zg_j^^@w30'
...
CORS_ALLOWED_ORIGINS = [
  ...
  "http://store.alesta.group:8080",
  "http://178.168.146.123:80",
  "http://46.53.136.102:80"
]
...
# Длина минимального пароля для пользователя
# AUTH_PASSWORD_VALIDATORS = [
#     {
#         'NAME': 'django.contrib.auth.password_validation.MinimumLengthValidator',
#         'OPTIONS': {
